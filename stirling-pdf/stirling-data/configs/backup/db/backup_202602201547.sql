...
;              
CREATE USER IF NOT EXISTS "SA" SALT '9f7b805d90a38922' HASH 'eca6f570a0911179e9d0408616a74c826fdd69801ff6f2ceaa53d56299db9e07' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "FORCE_PASSWORD_CHANGE", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TIMESTAMP '2026-02-20 15:47:53.545695', TRUE, FALSE, FALSE, TRUE, FALSE, '$2a$10$w3//gFMhRWD14P.v5AhRS.57LgUHg0/GUxSfuHN0Qbc2rpVQsqGMy', NULL, NULL, NULL, TIMESTAMP '2026-02-20 15:47:53.54574', 'admin', 1);      
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "FORCE_PASSWORD_CHANGE", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(2, '22361d9c-3a29-4c90-94e9-bf9238279f93', 'web', TIMESTAMP '2026-02-20 15:47:53.739504', TRUE, FALSE, FALSE, FALSE, FALSE, '$2a$10$ZY1ztyobbG/x11hroXRntex/YxqxjHckH2OaQnJ3DRu84DD8BYy1W', NULL, NULL, NULL, TIMESTAMP '2026-02-20 15:47:53.82171', 'STIRLING-PDF-BACKEND-API-USER', 2);           
