...
;              
CREATE USER IF NOT EXISTS "SA" SALT '622c61b82c6698d5' HASH '6bed1007cf56f622e2e0667d072f07ed27ac7f6df218955ee38a2f22348f4510' ADMIN;          
...
INSERT INTO "PUBLIC"."USER_LICENSE_SETTINGS"("ID", "GRANDFATHERED_USER_COUNT", "GRANDFATHERED_USER_SIGNATURE", "GRANDFATHERING_LOCKED", "INTEGRITY_SALT", "LICENSE_MAX_USERS") VALUES(1, 5, '5:X595Frl8Lg4c3mju3AkN0WJvLcIDZbeL1-4i6KF98Mg', TRUE, '391bd158-8ae3-46c4-bc6a-1f2d2fb550ec', 0); 
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "FORCE_PASSWORD_CHANGE", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(1, '29598011-3696-4c61-924d-97b6cd967fdb', 'web', TIMESTAMP '2026-02-20 12:45:34.734', TRUE, FALSE, FALSE, FALSE, FALSE, '$2a$10$158ZrO4gK3dbkIJgbQ5/dOWKEkY5EyBQKRWXWX8VDgJUoEzKqGXWC', NULL, NULL, NULL, TIMESTAMP '2026-02-20 14:21:54.15478', 'admin', 1);      
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "FORCE_PASSWORD_CHANGE", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(2, 'f259bf50-74ae-486d-91a8-a009d9de9563', 'web', TIMESTAMP '2026-02-20 12:45:34.949126', TRUE, FALSE, FALSE, FALSE, FALSE, '$2a$10$8XPZePQ2mIh0YHpejkaUjOVKsAzMMBFh3QPYzqhRB6LbQZAe216q2', NULL, NULL, NULL, TIMESTAMP '2026-02-20 12:45:35.02997', 'STIRLING-PDF-BACKEND-API-USER', 2);           
